...
class InstrumentDataSource {
    ...
    private val questions: Map<String, List<Question>> = mapOf(
        ...
        "Gestión humana" to listOf(
            Question("Revise el proceso de selección de los funcionarios y contratistas, verifique que se lleva a cabo una revisión de: \n" +
        ...
        "Responsable de compras y adquisiciones" to listOf(
            ...
            Question("1) Indague y solicite evidencia en una muestra de proveedores seleccionada, como la entidad hace seguimiento, revisa y audita con regularidad de acuerdo a la política la prestación de servicios de los proveedores y el cumplimiento de los compromisos respecto a la seguridad de la información.\n" +
        ...
        "Responsable de la continuidad" to listOf(
            Question("Indagar si la Entidad cuenta con un BCP (Bussines Continuity Plan) o DRP (Disaster Recovery Plan).\n" +
            ...
            Question("Verifique si la entidad cuenta con\n" +
            ...
            Question("Indague y solicite evidencias de la realización de pruebas de la funcionalidad de los procesos, procedimientos y controles de continuidad de la seguridad de la información, para asegurar que son coherentes con los objetivos de continuidad de la seguridad de la información; \n" +
                    " \n" +
            ...
            Question("Verifique si la Entidad cuenta con arquitecturas redundantes, ya sea un centro de cómputo principal y otro alterno o componentes redundantes en el único centro de cómputo.\n" +
        ...
        "Responsable de SI" to listOf(
            Question("Solicite la política de seguridad de la información de la entidad y evalúe:\n" +
            ...
            Question("Pregunte si la entidad asigna dispositivos móviles a sus funcionarios o permite que los dispositivos de estos ingresen a la entidad.\n" +
            ...
            Question("Solicite el inventario de activos de información, revisado y aprobado por la alta Dirección y revise:\n" +
            ...
            Question("Verifique si se realizan evaluaciones de seguridad técnicas por o bajo la supervisión de personal autorizado, apoyado en herramientas automáticas o con revisiones manuales realizadas por especialistas. \n" +
        ...
        "Responsable de TICs" to listOf(
            Question("Definición de teletrabajo: El teletrabajo hace referencia a todas las formas de trabajo por fuera de la oficina, incluidos los entornos de trabajo no tradicionales, a los que se denomina \"trabajo a distancia\", \"lugar de trabajo flexible\", \"trabajo remoto\" y ambientes de \"trabajo virtual\".\n" +
                    "\n" +
            ...
            Question("Solicite las directrices, guías, lineamientos y procedimientos para la gestión de medios removibles, que consideren:\n" +
            ...
            Question("Solicite los procedimientos existentes para garantizar que los medios a desechar o donar, no contienen información confidencial que pueda ser consultada y copiada por personas no autorizadas.\n" +
                    "\n" +
                    "Verifique si se ha realizado esta actividad y si existen registros de la misma."),
            Question("Solicite las directrices definidas para la protección de medios que contienen información durante el transporte. Verifique de acuerdo a las mejores prácticas que se contemple:\n" +
                    "\n" +
            ...
            Question("1) Solicite los procedimientos para el cumplimiento de los requisitos y contractuales relacionados con los derechos de propiedad intelectual y el uso de productos de software patentados. \n" +
